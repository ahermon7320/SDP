# Basic Structure for AMD User Interface
# Change Options, colors, and functionalities accordingly
# Still Needed: Add Pill connection with camera, as well
# connecting with dispenser to update screen, and play sound when 
...
class MedicationDispenser(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Automatic Medication Dispenser')
